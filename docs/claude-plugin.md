...
[Common Query pipeline](cq-pipeline.md), [OCP](ocp-pipeline.md) media search, and [Mixture of Solvers](mos-plugin.md).
...
- [Mixture of Solvers](mos-plugin.md) — using Claude engines as workers or kings


- [OpenAI Plugin](openai-plugin.md) — OpenAI-compatible alternative
