...
|---|---|
| `@intent_handler("file.intent")` | Register Padatious or Adapt intent handler |
...
- [ovos-core](102-core.md) — `SkillManager`, `IntentService`, skill loading
- [Converse Pipeline](converse_pipeline.md) — `ConversationalSkill` in action
- [Fallback Pipeline](fallback_pipeline.md) — `FallbackSkill` in action
- [Skill Settings](408-skill_settings.md) — `self.settings` persistence
- [Skill Filesystem](407-skill_filesystem.md) — `self.file_system`
- [Skill API](409-skill_api.md) — `@skill_api_method`, inter-skill calls
- [Bus Session](901-bus-session.md) — session state available to skills
