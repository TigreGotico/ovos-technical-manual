...
Eggscript is a markup language that can be "compiled" into a valid OVOS [Skill](skill-design-guidelines.md)
...
hello.eggscript
        ...
        // you can define python code, executed after [TTS](tts-plugins.md)
        ```
        hello = "world"
        if hello == "world":
            print("python code!")
