...
2. **Parallel [Skill](skill-design-guidelines.md) Querying:** The plugin sends the utterance to all registered common query skills capable of answering general knowledge questions.
