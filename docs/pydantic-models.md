...
```python
from ovos_pydantic_models.listener.recognizer_loop import RecognizerLoopUtteranceMessage
# (also importable flat: `from ovos_pydantic_models import RecognizerLoopUtteranceMessage`)
