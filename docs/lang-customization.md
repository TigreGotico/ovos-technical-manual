...
!!! abstract "Specification"
    Locale resource layout and file formats are defined by the **[OVOS-INTENT-2: Locale Resource Formats Specification](https://github.com/OpenVoiceOS/architecture/blob/dev/ovos-intent-2.md)** (companion to OVOS-INTENT-1, the sentence-template grammar). This page describes how OVOS implements that spec; the spec is the normative reference.
