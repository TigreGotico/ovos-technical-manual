...
`ovos-gguf-plugin` provides feature-parity with [ovos-claude-plugin](157-claude-plugin.md) using
...
Used by the [Common Query pipeline](cq_pipeline.md), OCP media search, and
[Mixture of Solvers](155-mos-plugin.md) as judge/king/referee.
...
## Utterance Transformer (`opm.transformer.text`)
...
Runs after skill response generation, before TTS synthesis. Rewrites skill responses using a
...
- [Mixture of Solvers](155-mos-plugin.md) — using GGUF engines as offline workers in MoS
- [Claude Plugin](157-claude-plugin.md) — Anthropic Claude cloud alternative
- [OpenAI Plugin](158-openai-plugin.md) — OpenAI-compatible API alternative
